...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "0d478a69-d551-4fc1-a25c-6cf9d40808b9",
  ...
  "public": {},
  "weatherApiKey": "wai_f761ad.b3306925e1d538bc9271efd4d5221a0961226645686b2613",
  "weatherApiBase": "https://api.weather-ai.co"
};
const envOptions = {
  prefix: "NITRO_",
...
const _lazy_lEfq8G = () => import('../routes/api/geocode.get.mjs');
const _lazy_GfJwc1 = () => import('../routes/api/hourly.get.mjs');
const _lazy_pdfaSw = () => import('../routes/api/usage.get.mjs');
const _lazy_dm9EIA = () => import('../routes/api/weather-geo.get.mjs');
const _lazy_3g2Iqk = () => import('../routes/api/weather.get.mjs');
const _lazy_pPW7W4 = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/geocode', handler: _lazy_lEfq8G, lazy: true, middleware: false, method: "get" },
  { route: '/api/hourly', handler: _lazy_GfJwc1, lazy: true, middleware: false, method: "get" },
  { route: '/api/usage', handler: _lazy_pdfaSw, lazy: true, middleware: false, method: "get" },
  { route: '/api/weather-geo', handler: _lazy_dm9EIA, lazy: true, middleware: false, method: "get" },
  { route: '/api/weather', handler: _lazy_3g2Iqk, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_pPW7W4, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_pPW7W4, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch as $, defineRenderHandler as a, getRouteRules as b, createError$1 as c, defineEventHandler as d, encodePath as e, getResponseStatusText as f, getQuery as g, getResponseStatus as h, useNitroApp as i, joinRelativeURL as j, decodePath as k, hasProtocol as l, isScriptProtocol as m, joinURL as n, getContext as o, parseURL as p, createHooks as q, executeAsync as r, sanitizeStatusCode as s, defu as t, useRuntimeConfig as u, parseQuery as v, withQuery as w, withTrailingSlash as x, withoutTrailingSlash as y, handler as z };
